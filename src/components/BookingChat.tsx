...
interface BookingChatProps {
  ...
  /** Render as an inline panel (no backdrop/fixed positioning) — used inside page layouts */
  inline?: boolean;
}
...
export function BookingChat({
  ...
  /* ── INLINE MODE: renders as a flex column panel (no fixed/absolute) ── */
  if (inline) {
    return (
  ...
  /* ── OVERLAY MODE: mobile bottom drawer ── */
  return (
    <>
      <div
        ...
        onClick={onClose}
      />
      <div className="fixed inset-x-0 bottom-0 z-50 flex flex-col bg-card border-t border-border rounded-t-3xl shadow-2xl animate-in slide-in-from-bottom duration-200"
