      ...
      <div className="flex items-end justify-between mb-6 md:mb-10 border-b border-border pb-5 md:pb-6">
        ...
        {primaryVehicle && (
          <div className="text-right">
            ...
            <p className="text-foreground/70 md:text-foreground text-xs md:text-[15px] font-medium leading-tight">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_340px] xl:grid-cols-[1fr_380px] gap-6 lg:gap-8 items-start">
        ...
        <div className="space-y-6 md:space-y-8 min-w-0">
          ...
          <Link href="/app/book" className="block group">
            <div className="relative overflow-hidden rounded-xl bg-card border border-border p-6 md:p-8 lg:p-10 min-h-[260px] md:min-h-[340px] flex flex-col justify-between hover:border-border transition-colors">
              ...
              <div className="flex items-end justify-between">
                <div>
                  ...
                  <span className="flex items-center gap-2">
                    ...
                    <span className="text-foreground/60 text-[13px] md:text-[14px]">
            ...
            <div className="flex md:grid md:grid-cols-3 gap-3 md:gap-4 overflow-x-auto pb-1 -mx-5 px-5 md:mx-0 md:px-0 snap-x snap-mandatory md:snap-none scrollbar-hide">
              {services.map(({ plan, sku, label, desc, time, tag }) => (
                <Link key={plan} href={`/app/book?plan=${plan}`} className="block flex-shrink-0 w-[200px] md:w-auto snap-start">
                  <div
                    className={`h-full rounded-xl bg-card border border-border hover:border-border transition-colors flex flex-col justify-between relative overflow-hidden ${tag ? 'border-t-[2px] border-t-[#E23232]' : ''
                      }`}
                    style={{ minHeight: 220 }}
                  >
                    ...
                    <div className="relative z-10 p-4 md:p-5 pt-3 flex items-end justify-between">
                      ...
                      <p className="text-foreground text-[20px] md:text-[22px] font-light tracking-[-0.01em]">
        ...
        <div className="space-y-5 md:space-y-6">
          ...
          {primaryVehicle ? (
            <div className="rounded-xl bg-card border border-border p-6 md:p-7 relative overflow-hidden">
              ...
              <div className="flex items-end justify-between mb-2">
                ...
                <div className="shrink-0 -mr-1 -mb-1 opacity-[0.12]">
                  <CarFront className="w-28 md:w-36 h-28 md:h-36 text-foreground" strokeWidth={1} />
                </div>
              </div>
            ...
            <Link href="/app/onboarding" className="block">
              <div className="rounded-xl bg-card border border-dashed border-border p-6 text-center hover:border-[#E23232]/30 transition-colors">
