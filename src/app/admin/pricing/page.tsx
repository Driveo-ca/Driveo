            ...
            <div className="p-6 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground/55 dark:text-foreground/50 text-xs">Per wash pricing for each plan</p>
                </div>
              </div>
            </div>
            <div className="p-6">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                {Object.entries(perWashPrice).map(([plan, cents]) => (
                  ...
                  >
                    <Label className="text-foreground/55 dark:text-foreground/50 text-[10px] uppercase tracking-widest">
            ...
            <div className="p-6 border-b border-border">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-foreground/55 dark:text-foreground/50 text-xs">Recurring plan pricing</p>
                </div>
              </div>
            </div>
              ...
              {plans.map((plan) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-foreground/55 dark:text-foreground/50 text-sm">$</span>
                    <Input
                      type="number"
