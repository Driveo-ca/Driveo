        ...
        <div className="bg-surface border border-border rounded-2xl overflow-hidden">
          <div className="divide-y divide-border">
            {recentBookings.map((b, idx) => (
              <div
                key={b.id}
                className="p-4 flex items-center gap-4 hover:bg-foreground/[0.06] dark:hover:bg-foreground/[0.03] transition-colors duration-200 group"
              ...
              >
                ...
                <span className="text-foreground/50 dark:text-foreground/20 text-xs whitespace-nowrap font-mono">
